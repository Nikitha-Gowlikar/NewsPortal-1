...
import 'package:newsportal1/View/LocalNews/LocalPostDetails.dart';
...
class _LocalAllNewsState extends State<LocalAllNews> {
  Future getallPost() async {
    ...
    QuerySnapshot snap = await firestore.collection("LocalNews").getDocuments();
