...
import 'package:newsportal1/View/StudentsHub/StudentPostDetails.dart';

class In_AllNews extends StatefulWidget {
  @override
  _In_AllNewsState createState() => _In_AllNewsState();
}
...
class _In_AllNewsState extends State<In_AllNews> {
  Future getallPost() async {
    ...
    QuerySnapshot snap =
    await firestore.collection("Students").getDocuments();
